    ...
    def init(self, cr):
        ...
        cr.execute("""
            create or replace view doanhthu_graph_report as (
                ...
                select id, daily_id, ky_ve_id, sum(doanh_thu) as doanh_thu, ngay_mo_thuong
                from
                (
                ...
                select vel.phanphoi_line_id as id, vel.daily_id as daily_id, ve.ky_ve_id as ky_ve_id,-1*vel.thuc_kiem*lv.gia_tri as doanh_thu, kv.ngay_mo_thuong as ngay_mo_thuong
