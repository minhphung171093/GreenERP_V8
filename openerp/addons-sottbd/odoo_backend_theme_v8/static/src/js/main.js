openerp.odoo_backend_theme_v8 = function (instance) {
    ...
    instance.web.Client.include({
        ...
        bind_events: function () {
            ...
            var elem_sm = $("<button id='leftbar_toggle' type='button' class='navbar-toggle left'><span class='icon-bar'></span><span class='icon-bar'></span><span class='icon-bar'></span></button>");
            elem_sm.prependTo(root.find('.navbar-header'));
            this.$('.oe_secondary_menus_container').mCustomScrollbar({theme:"dark"});
