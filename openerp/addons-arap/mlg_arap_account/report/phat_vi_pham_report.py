    ...
    def get_line(self):
        ...
        sql = '''
            select ai.name as ma_giaodich, ai.date_invoice as ngay_giaodich, cn.code as ma_chinhanh, cn.name as ten_chinhanh,
                ...
                dx.name as ten_doixe, lvp.name as loai_vipham, ai.ngay_vi_pham as ngay_vi_pham, ai.so_bien_ban_vi_pham as so_bien_ban_vi_pham,
                ail.price_unit as sotien, ail.name as diengiai
                ...
                where date_invoice between '%s' and '%s' and mlg_type='phat_vi_pham' 
        '''%(from_date,to_date)
