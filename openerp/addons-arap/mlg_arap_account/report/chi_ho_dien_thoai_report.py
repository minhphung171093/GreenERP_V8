    ...
    def get_line(self):
        ...
        sql = '''
            select ai.name as ma_giaodich, ai.date_invoice as ngay_giaodich, cn.code as ma_chinhanh, cn.name as ten_chinhanh,
                ...
                dx.name as ten_doixe, ai.so_hoa_don as so_hoa_don, aj.name as loai_giaodich, ail.price_unit as sotien, ail.name as diengiai
                ...
                where date_invoice between '%s' and '%s' and mlg_type='chi_ho_dien_thoai' 
        '''%(from_date,to_date)
