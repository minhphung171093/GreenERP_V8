...
class Parser(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({
            'get_ma_bang_chiettinh_chiphi_sua': self.get_ma_bang_chiettinh_chiphi_sua,
    ...
    def get_ma_bang_chiettinh_chiphi_sua(self):
    ...
    def get_line(self):
        ...
        sql = '''
            select rp.name as tendoituong, ai.mlg_type as loaicongno, ai.so_tien as sotien
                ...
                where ai.ma_bang_chiettinh_chiphi_sua='%s' 
