    ...
    def get_line(self, ldt):
        ...
        sql = '''
              select ai.name as ma_giaodich, ai.date_invoice as ngay_giaodich, cn.code as ma_chinhanh, cn.name as ten_chinhanh,
                ...
                lndt.name as loainodoanhthu,ai.residual as sotienconlai,(ai.so_tien-ai.residual) as sotiendathu
                ...
                left join loai_no_doanh_thu lndt on ai.loai_nodoanhthu_id = lndt.id
                where ai.state='open' and ai.chinhanh_id=%s and ai.date_invoice between '%s' and '%s' and ai.mlg_type in ('no_doanh_thu') 
        ...
        loai_nodoanhthu = wizard_data['loai_nodoanhthu_id']
        if loai_nodoanhthu:
            sql+='''
