...
class tonghop_congno_kyquy(osv.osv_memory):
    _name = "tonghop.congno.kyquy"
    ...
    _columns = {
        ...
        'partner_ids': fields.many2many('res.partner', 'thcnkq_doituong_ref', 'dscn_id', 'doituong_id', 'Đối tượng'),
