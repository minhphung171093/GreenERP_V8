...
class chitiet_congno_kyquy(osv.osv_memory):
    _name = "chitiet.congno.kyquy"
    ...
    _columns = {
        ...
        'partner_ids': fields.many2many('res.partner', 'ctcnkq_doituong_ref', 'dscn_id', 'doituong_id', 'Đối tượng'),
