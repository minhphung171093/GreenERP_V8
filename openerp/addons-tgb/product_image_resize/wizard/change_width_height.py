...
class change_width_height(osv.osv_memory):
    ...
    def update_width_height(self, cr, uid, ids, context=None):
        ...
        product_obj.write(cr, uid, product_ids, {'width':this.width,'height':this.height})
        
        product_temp_obj = self.pool.get('product.template')
        product_temp_ids = context.get('active_ids',[])
        product_temp_obj.write(cr, uid, product_temp_ids, {'width':this.width,'height':this.height})
